...
kotlin {
    ...
    val xcf = XCFramework("TracingSubscriber")

    macosArm64 {
        binaries.framework { baseName = "TracingSubscriber"; xcf.add(this) }
    }
    iosArm64 {
        binaries.framework { baseName = "TracingSubscriber"; xcf.add(this) }
    }
    ...
    swiftExport {
        moduleName = "TracingSubscriber"
        flattenPackage = "io.github.kotlinmania.tracingsubscriber"
    }

    android {
        namespace = "io.github.kotlinmania.tracingsubscriber"
        compileSdk = 34
        minSdk = 24
...
mavenPublishing {
    ...
    coordinates(group.toString(), "tracing-subscriber-kotlin", version.toString())

    pom {
        name.set("tracing-subscriber-kotlin")
        description.set("Kotlin Multiplatform port of tokio-rs/tracin - Utilities for implementing and composing `tracing` subscribers")
        inceptionYear.set("2026")
        url.set("https://github.com/KotlinMania/tracing-subscriber-kotlin")
        ...
        scm {
            url.set("https://github.com/KotlinMania/tracing-subscriber-kotlin")
            connection.set("scm:git:git://github.com/KotlinMania/tracing-subscriber-kotlin.git")
            developerConnection.set("scm:git:ssh://github.com/KotlinMania/tracing-subscriber-kotlin.git")
        }
    }
}
...
val fullTargetBuildTasks = listOf(
    ...
    "assembleTracingSubscriberXCFramework",
    "assembleTracingSubscriberDebugXCFramework",
    "assembleTracingSubscriberReleaseXCFramework",
    "assembleDebugIosFatFrameworkForTracingSubscriberXCFramework",
    "assembleReleaseIosFatFrameworkForTracingSubscriberXCFramework",
    "assembleDebugIosSimulatorFatFrameworkForTracingSubscriberXCFramework",
    "assembleReleaseIosSimulatorFatFrameworkForTracingSubscriberXCFramework",
    "assembleDebugMacosFatFrameworkForTracingSubscriberXCFramework",
    "assembleReleaseMacosFatFrameworkForTracingSubscriberXCFramework",
    "assembleDebugTvosFatFrameworkForTracingSubscriberXCFramework",
    "assembleReleaseTvosFatFrameworkForTracingSubscriberXCFramework",
    "assembleDebugTvosSimulatorFatFrameworkForTracingSubscriberXCFramework",
    "assembleReleaseTvosSimulatorFatFrameworkForTracingSubscriberXCFramework",
    "assembleDebugWatchosFatFrameworkForTracingSubscriberXCFramework",
    "assembleReleaseWatchosFatFrameworkForTracingSubscriberXCFramework",
    "assembleDebugWatchosSimulatorFatFrameworkForTracingSubscriberXCFramework",
    "assembleReleaseWatchosSimulatorFatFrameworkForTracingSubscriberXCFramework",
