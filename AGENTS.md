...
This file is the quick-reference operating contract for tracing-subscriber-kotlin. The longer
...
tracing-subscriber-kotlin is a Kotlin Multiplatform port of the upstream Rust crate or module
[`tracing-subscriber`](https://crates.io/crates/tracing-subscriber). Upstream Rust is the behavioral oracle while the
